...
<div id="OrientationsGeneral" className=" relative flex flex-col justify-start items-center">
    <div className="relative flex items-center justify-center w-full">
        ...
        <div className="absolute z-20 w-full flex flex-col items-center justify-center md:max-w-6xl gap-10 top-28">
            ...
            <div className="grid grid-cols-2 w-full items-start justify-center gap-16 text-center pt-5 relative top-16">
                <div className="flex items-start justify-start gap-5">
                    <div
                        className="flex flex-col gap-2 items-start justify-start text-white">
                        <p className="text-left font-bold border-l-4 border-amber-400 pl-2 uppercase text-xl">AULAS PREPARATÓRIAS EXCLUSIVAS</p>
                ...
                <div className="flex items-start justify-start gap-5">
                    <div
                        className="flex flex-col gap-2 items-start justify-start text-white">
                        <p className="text-left border-l-4 border-amber-400 pl-2 uppercase text-xl">TRILHA DE <span className="font-bold">APRENDIZAGEM COMPLETA</span></p>
                ...
                <div className="flex items-start justify-start gap-5">
                    <div
                        className="flex flex-col gap-2 items-start justify-start text-white">
                        <p className="text-left border-l-4 border-amber-400 pl-2 uppercase text-xl">BASEADO NO <span className="font-bold">CURRÍCULO ESCOLAR</span></p>
                ...
                <div className="flex items-start justify-start gap-5">
                    <div
                        className="flex flex-col gap-2 items-start justify-start text-white">
                        <p className="text-left font-bold border-l-4 border-amber-400 pl-2 uppercase text-xl">SIMULADOS <span className="font-normal">PARA PRATICAR</span></p>
