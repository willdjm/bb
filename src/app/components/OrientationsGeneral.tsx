...
<>
<div id="OrientationsGeneral" className="hidden relative md:flex flex-col justify-start items-center -top-80">
...
<div id="OrientationsGeneral" className="md:hidden relative flex flex-col justify-start items-start">
        <picture className=" w-full relative">
            <img src="/bg-orientacoes-mobile.png" className="w-full object-cover h-[115rem] relative" alt="" />
        </picture>
