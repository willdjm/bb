...
<div className='md:justify-between flex flex-col justify-items-center md:max-w-6xl w-full gap-3'>
    ...
    <div className='grid lg:flex lg:items-baseline w-full lg:justify-center'>
        <span className="lg:text-base text-white text-center">Copyright 2024   : :   Onano - Olímpíada Nacional de Nanotecnologia.   : :   Todos os direitos reservados.</span>
    </div>
    <div className='flex items-baseline justify-center gap-5 w-auto'>
                <a className='' href="https://sacorp.tec.br/?utm_source=www.mayerbastoscostaadv.com.br&utm_medium=banner&utm_campaign=slogan" target='_blank' rel="noreferrer">
                    <picture>
