...
<div id="" className=" relative flex flex-col justify-start items-center">
    <div className="relative flex items-center justify-center w-full">
        <picture className=" w-full relative">
            <img src="/banner.webp" className="w-full h-auto relative" alt="" />
        </picture>
        <div className="absolute top-[36rem] ml-10 z-20 w-full flex items-start justify-start max-w-6xl gap-[67px]">
            <h3 className="text-white uppercase text-3xl w-60 flex flex-col gap-4">ENTRE NESTE <span
    ...
    <div
        className="absolute z-40 gap-5 flex items-center justify-center w-full bg-gradient-to-b from-blue-950 to-Blue-950/10">
        <picture className="">
