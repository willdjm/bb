...
<div id="RulesAndRegulations" className="flex flex-col justify-start items-center bg-Teal-600 ">
    <div className='md:justify-center flex flex-col justify-items-center md:max-w-6xl w-full gap-10'>
    </div>
    <div className="relative flex items-center justify-center w-full">
        <picture className=" w-full relative">
            <img src="/bg-regras.webp" className="w-full h-auto relative" alt="" />
        </picture>
        <div className="absolute gap-16 z-20 w-full flex flex-col items-center justify-center">
            <p className="text-blue-950 font-bold text-4xl uppercase">REGRAS E REGULAMENTOS</p>
            <p className="text-Blue-950 text-lg">Para garantir uma competição justa e organizada, todos os participantes
    ...
    <div className="relative flex items-center justify-center w-full pt-52">
        <div className="absolute z-0 w-full flex items-start justify-start -top-32 mr-8">
            <picture className="">
                <img src="/img-regras.webp" className="" alt="" />
            </picture>
        </div>
    </div>
    <div className="relative flex items-center justify-center -bottom-5">
        <picture>
            <img src="/img-oportunidades-pos-graduandos.webp" className="" alt="" />
        </picture>
        <div className="absolute top-60 z-20 w-full flex flex-col items-start justify-center max-w-6xl gap-4">
            <p className="text-white uppercase text-2xl">OPORTUNIDADE PARA</p>
            <p className="text-amber-400 font-bold uppercase max-w-2xl text-5xl pt-4">PÓS-GRADUANDOS EM NANOTECNOLOGIA!
            </p>
