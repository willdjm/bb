...
const sidebarRef = useRef<HTMLDivElement>(null);
    ...
    <>
        {/* MOBILE */}
        <div className="absolute z-50 bg-transparent md:hidden block w-full">
            {/* Sidebar */}
            <div className={`fixed bg-amber-400 text-white w-full z-50 min-h-screen overflow-y-auto transition-transform
                ...
                <div className="">
                    ...
                    <div className="p-8 flex justify-center flex-col gap-5">
                        <Link href='#AboutMobile' onClick={closeSidebar} className="text-white text-lg">Sobre</Link>
                        <Link href='#ObjectivesAndBenefitsMobile' onClick={closeSidebar} className="text-white text-lg">
                        Objetivos</Link>
                        <Link href='#HowItWorksMobile' onClick={closeSidebar} className="text-white text-lg">Como
                        Funciona</Link>
                        <Link href='#ProgrammingMobile' onClick={closeSidebar} className="text-white text-lg">
                        Programação</Link>
                        <Link href='#WhoCanParticipateMobile' onClick={closeSidebar} className="text-white text-lg">Quem
                        pode participar</Link>
