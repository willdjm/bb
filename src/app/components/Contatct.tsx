...
<div id="Contact" className=" flex flex-col justify-center items-center bg-Teal-600 py-10 md:py-0 h-[30rem]">
    <div className='md:justify-center flex flex-col justify-items-center md:max-w-6xl w-full gap-10'>
        ...
        <div className="flex flex-col w-full items-center justify-center relative -top-28">
            <p className="text-blue-950 font-bold text-xl">Tem alguma dúvida ou precisa de mais informações?</p>
            <p className="text-Blue-950 text-xl">Entre em contato conosco!</p>
            <p className="text-Blue-950 mt-10 text-xl">E-mail: <a href="mailto:onanobrasil@gmail.com">onanobrasil@gmail.com</a></p>
        </div>
    </div>
</div>
);
