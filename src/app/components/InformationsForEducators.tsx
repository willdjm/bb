...
<div id="InformationsForEducators" className="flex flex-col justify-center items-center w-full relative -top-[40rem]">
...
<div>
<p className="text-center text-lg">Queremos convidá-lo(a) a se cadastrar e aproveitar uma série de</p>
<span className="font-bold text-lg"> benefícios exclusivos para você e seus alunos.</span>
</div>
<div>
<p className="text-center max-w-2xl text-lg">Nossa missão é promover o ensino da nanotecnologia nas escolas e
        ...
        <div className="grid grid-cols-2 w-full items-start justify-start text-blue-950 pt-5">
            <div className="flex items-start justify-start gap-10">
                ...
                <div className="flex flex-col gap-2 items-start justify-start">
                    ...
                    <p className="text-left text-base max-w-sm">Participe de cursos online focados no ensino da nanotecnologia, elaborados
                        pelo Prof.
                        Delmárcio Gomes e especialistas da área. </p>
                    <p className="text-left text-base max-w-sm">Você terá acesso a materiais didáticos, planos de aula e atividades
            ...
            <div className="flex items-start justify-start gap-10">
                ...
                <div className="flex flex-col gap-2 items-start justify-start">
                    ...
                    <p className="text-left text-base max-w-sm w-full">Oportunidade de assistir a lives exclusivas com profissionais da indústria,
                        pesquisadores nacionais renomados e alunos de pós-graduação que estão no ramo da pesquisa da
                        nanotecnologia.</p>
                    <p className="text-left text-base">Essas sessões oferecerão insights valiosos e responderão a perguntas
            ...
            <div className="flex items-start justify-start gap-10 pt-10">
                ...
                <div className="flex flex-col gap-2 items-start justify-start">
                    ...
                    <p className="text-left text-base max-w-sm">Conecte-se com outros educadores, pesquisadores e profissionais da
                        indústria.</p>
                    <p className="text-left text-base max-w-sm">Amplie sua rede de contatos, trocando experiências e ideias para enriquecer
            ...
            <div className="flex items-start justify-start gap-10 pt-10">
                ...
                <div className="flex flex-col gap-2 items-start justify-start">
                    ...
                    <p className="text-left text-base">Ao participar dos cursos de capacitação, você receberá certificados que
                        atestam sua participação e dedicação ao ensino da nanotecnologia.</p>
                    <p className="text-left text-base">Esses certificados podem enriquecer seu currículo e abrir portas para novas
                        oportunidades.</p>
                </div>
            </div>
        </div>
    ...
    <div className="relative flex items-center justify-start w-full">
        ...
        <div className="absolute -top-5 z-20 flex">
            ...
            <div className="absolute top-20 z-20 w-full flex flex-col items-center justify-center max-w-6xl gap-5 pr-3">
                <h3 className="text-black font-bold uppercase text-xl text-center">Como se cadastrar?</h3>
                <p className="text-black max-w-md text-base text-center">Para se inscrever, basta clicar no botão abaixo e
                    preencher o formulário com suas informações.</p>
                <p className="text-black max-w-[30rem] text-base text-center">Nossa equipe entrará em contato com você para
                    fornecer mais detalhes sobre os cursos e eventos disponíveis.
                </p>
                <button className="py-2 px-6 font-semibold bg-green-900 text-white rounded-xl text-base text-center">
