...
<div className=" relative flex flex-col justify-start items-center -top-80">
    ...
    <div className="relative flex items-center justify-center w-full -bottom-20">
        <picture className=" w-full relative">
            <img src="/bg-objetivos.webp" className="w-full h-auto relative z-30" alt="" />
        </picture>
        <div className="absolute z-50 w-full flex flex-col items-start justify-start md:max-w-6xl gap-10 top-28">
            <div className="grid grid-cols-1 w-full items-start justify-start gap-14 text-center pt-5 relative max-w-[30rem]">
                <div className="flex items-start justify-start">
                    <div
                        className="flex flex-col items-start justify-start">
                        <p className="text-left text-[43px] font-medium text-amber-400 uppercase">DIVULGAR</p>
                        <p className="text-left border-b border-amber-400 text-amber-400 font-semibold text-[21px]">a ciência e popularizar a nanotecnologia</p>
                        <p className="text-left text-white text-[17px] pt-5">A realização de eventos nacionais como a ONANO é essencial para divulgar essa área da Ciência nas escolas e aproximar a nanotecnologia do público em geral. Ao popularizar a ciência, contribuímos para formar uma sociedade mais informada e engajada com as questões científicas e tecnológicas.</p>
                    </div>
                </div>
                <div className="flex items-start justify-start">
                    <div
