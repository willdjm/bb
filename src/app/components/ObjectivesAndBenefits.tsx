...
<>
<div className="relative hidden md:flex flex-col justify-start items-center -top-80">
...
<div className="relative md:hidden flex flex-col justify-center items-center">
    ...
    <div className="relative flex items-center justify-center w-full py-10">
        <picture className=" w-full relative">
            <img src="/bg-objetivos-mobile.png" className="object-cover w-full h-auto relative z-30" alt="" />
        </picture>
